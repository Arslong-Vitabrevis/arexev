...
impl fmt::Display for ParserError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            self::ParserError::UnableToParse(e) => write!(f, "Error in evaluating {}", e),
            self::ParserError::InvalidOperator(e) => write!(f, "Error in evaluating {}", e),
        }
    }
}
